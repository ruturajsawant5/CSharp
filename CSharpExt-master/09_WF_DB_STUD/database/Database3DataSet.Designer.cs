...
namespace database {
    ...
    public partial class Database3DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Table1Row AddTable1Row(string First_Name, string Last_Name) {
...
namespace database.Database3DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `First_Name` IS NULL) OR (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`First_Name`, `Last_Name`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `First_Name` = ?, `Last_Name` = ? WHERE ((`ID` = ?) AND ((? =" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::database.Properties.Settings.Default.Database3ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, First_Name, Last_Name FROM Table1";
        ...
        public virtual int Fill(Database3DataSet.Table1DataTable dataTable) {
        ...
        public virtual Database3DataSet.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database3DataSet.Table1DataTable dataTable = new Database3DataSet.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database3DataSet.Table1DataTable dataTable) {
